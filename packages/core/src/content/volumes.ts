...
export const CHOOSER_COPY: Record<string, string> = {
  ...
  "past.time": "Two or three sessions. The longest of the three.",
  "present.line": "What gets in your way, and what you're good at, in plain words.",
  "present.time": "One or two sessions, about twenty minutes a deck.",
  "future.line": "Three to five years out, then the goals, then the plan you live by.",
  "future.time": "Three short sessions. Two minutes, then fifteen, then twenty.",
...
export const EXPLAINER_COPY: Record<string, string> = {
  ...
  "future.para": "Future is fifteen minutes of writing about life three to five years on, if things went well. Then you name the goals that are already in what you wrote, and answer five short questions about each one. Out of that comes a plan and a Book you finish. Three short sessions.",
...
export const PAST_COPY: Record<string, string> = {
  ...
  "door.time": "Two or three sessions. The longest of the three.",

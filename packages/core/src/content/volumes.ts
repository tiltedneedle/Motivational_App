...
export const CHOOSER_COPY: Record<string, string> = {
  ...
  "future.time": "Five short steps, about forty minutes in all.",
...
export const EXPLAINER_COPY: Record<string, string> = {
  ...
  "future.para": "Future is fifteen minutes of writing about life three to five years on, if things went well. Then you name the goals that are already in what you wrote, and answer a few short questions about each one. Out of that comes a plan and a Book you finish.",
